...
public class ServiceBrowserTests : IDisposable
{
  ...
  {
    // Act
    this.browser.Browse (regtype: regtype, domain: domain);
  ...
  {
    // Act
    this.browser.Browse (addressProtocol: protocol, regtype: "_http._tcp", domain: "local");
  ...
  {
    // Act
    this.browser.Browse (interfaceIndex: interfaceIndex, regtype: "_http._tcp", domain: "local");
  ...
  public void Browse_WithAllParams_CallsUnderlyingBrowser (uint            interfaceIndex,
                                                           AddressProtocol addressProtocol,
                                                           string          regtype,
                                                           string          domain)
  {
    // Act
    this.browser.Browse (interfaceIndex: interfaceIndex, addressProtocol: addressProtocol, regtype: regtype, domain: domain);
  ...
  {
    // Act
    IEnumerator<IResolvableService> enumerator = this.browser.GetEnumerator ();
  ...
  {
    // Act
    IEnumerator<IResolvableService> enumerator = ((IEnumerable<IResolvableService>)this.browser).GetEnumerator ();
