...
public class BonjourRegistrationIntegrationTests : IDisposable
{
  ...
  public void Register_WithValidService_DoesNotThrowImmediately ()
  {
    ...
    // Act & Assert
    try { this.registerService.Register (); }
    catch (Exception ex)
    {
  ...
  public void Register_CanSubscribeToResponseEvent ()
  {
    ...
    catch (Exception ex) { Assert.True (ex is not null); }
  ...
  public void Register_WithTxtRecord_DoesNotThrow ()
  {
    ...
    txtRecord.Add (key: "version", value: "1.0");
    txtRecord.Add (key: "path",    value: "/api");
  ...
  public void RegisterService_PropertiesPreserveAfterRegister ()
  {
    ...
    Assert.Equal (expected: name,    actual: this.registerService.Name);
    Assert.Equal (expected: regType, actual: this.registerService.RegType);
    Assert.Equal (expected: port,    actual: this.registerService.Port);
  }
}
